  ...
  return (
    <main className="min-h-screen bg-[#FFFDF7] text-[#0B1F3A]">
      <section className="mx-auto max-w-6xl px-6 py-16">
        ...
        <section className="mt-10 rounded-[2rem] border-2 border-[#F0FDF4] bg-white p-8">
        ...
        <section className="mt-16 rounded-[2rem] border border-[#E7DAB9] bg-white p-8 shadow-sm">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <Link href="/learn/canadian-french-tests/unit-2/test" className="rounded-full bg-[#2563EB] px-6 py-3 text-sm font-black text-white shadow-sm transition hover:-translate-y-0.5 hover:bg-[#1D4ED8]">Unit 2 Test →</Link>
          </div>
        </section>
      </section>
    </main>
