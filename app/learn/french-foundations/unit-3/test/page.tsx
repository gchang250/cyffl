      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        ...
        <div className="mt-12 rounded-2xl border border-[#E7DAB9] bg-white p-8 shadow-sm">
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            ...
            <Link href="/learn/french-foundations/unit-4/lesson-1" className="rounded-full bg-[#D62828] px-6 py-3 text-sm font-black text-white shadow-sm transition hover:-translate-y-0.5 hover:bg-[#B91C1C]">Start Unit 4 →</Link>
          </div>
        </div>
      </section>
    </main>
