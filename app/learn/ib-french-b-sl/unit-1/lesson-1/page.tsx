      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        ...
        <section className="mt-16 rounded-2xl border border-[#E7DAB9] bg-white p-8 shadow-sm">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <Link href="/learn/ib-french-b-sl/unit-1/lesson-2" className="rounded-full bg-[#D62828] px-6 py-3 text-sm font-black text-white shadow-sm transition hover:-translate-y-0.5 hover:bg-[#B91C1C]">
              Next lesson →
            </Link>
          </div>
        </section>
