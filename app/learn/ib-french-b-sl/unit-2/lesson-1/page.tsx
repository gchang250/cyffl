...
const flashcards = [
  { front: "Vrai / Faux / On ne sait pas", back: "True / False / Not stated", subtext: "The most common Paper 1 question type. 'On ne sait pas' means the text doesn't say — don't infer." },
  { front: "Relevez…", back: "Find / Pick out…", subtext: "The instruction to locate specific words or phrases directly in the text." },
  { front: "Selon le texte…", back: "According to the text…", subtext: "A phrase in questions reminding you to use only what the text says." },
  { front: "Identifiez…", back: "Identify…", subtext: "Name or point out something from the text — often a purpose, audience, or idea." },
  { front: "Expliquez…", back: "Explain…", subtext: "Give a reason or meaning. Short answers required — examiners want clarity." },
  ...
  { front: "le public cible", back: "the target audience", subtext: "Who the text is written for — teenagers, professionals, tourists, etc." },
  ...
  { front: "le contexte", back: "context", subtext: "The setting and situation of the text — use it to guide your answers." },
];
...
const quiz = [
  {
    question: "A Paper 1 question asks: 'Vrai, Faux ou On ne sait pas? — L'auteur travaille dans une école.' The text says the author is a teacher but doesn't say where. What do you answer?",
    options: ["Vrai", "Faux", "On ne sait pas", "Vrai et Faux"],
    correct: 2,
    explanation: "On ne sait pas — the text doesn't confirm the author works in a school specifically. Never infer; only use what is directly stated.",
  },
  {
    ...
    options: ["To entertain readers", "To inform and persuade readers to choose eco-friendly travel", "To give factual data about tourism", "To warn against tourism"],
    correct: 1,
    explanation: "A brochure both informs and persuades — the purpose is to encourage eco-tourism. Always give both functions when relevant.",
  },
  {
  ...
  {
    question: "A text uses 'vous' throughout, discusses topics like business and finance, and is published in a professional magazine. What is the target audience?",
    options: ["Young children", "Professional adults", "Tourists", "Elementary school students"],
    correct: 1,
    explanation: "Formal register, vous, professional content = target audience of working adults. Le public cible questions require you to read context clues.",
  },
  {
    question: "Before reading a Paper 1 text carefully, the best first step is to:",
    options: ["Read the text from start to finish without stopping", "Read the questions first to know what to look for", "Translate every unfamiliar word", "Summarise the text mentally"],
    correct: 1,
    ...
    <main className="min-h-screen bg-[#FFFDF7] text-[#0B1F3A]">
      <section className="mx-auto max-w-6xl px-6 py-16">
        ...
        <div className="mt-6 grid gap-8 md:grid-cols-[1fr_1fr]">
          <div>
            ...
            <p className="mt-4 text-lg leading-8 text-[#526173]">
              Paper 1 is 45% of your grade. Learn the question types, key instructions,
              and strategies that save time and points.
            </p>
          </div>
          ...
          <div className="space-y-3">
            <div className="rounded-2xl bg-[#0B1F3A] p-5 text-white">
              ...
              <p className="mt-2 leading-7 text-white/80">
                ...
                On ne sait pas. The text must explicitly state it — don't assume.
              </p>
            </div>
            <div className="rounded-2xl border border-[#E7DAB9] bg-white p-5">
              ...
              <ul className="mt-2 space-y-1 text-sm text-[#0B1F3A]">
                <li>→ 1 hour 30 minutes total</li>
                <li>→ 45% of final grade</li>
                <li>→ Tests reading AND listening</li>
                <li>→ Multiple text types</li>
                <li>→ Questions in French</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <section className="mt-16">
          ...
          <p className="mt-1 text-[#526173]">Click a card to flip it. These are the instructions and concepts you'll see in every Paper 1.</p>
          <div className="mt-6">
            <FlashCardDeck cards={flashcards} title="Paper 1 — question vocabulary" />
          </div>
        </section>
        ...
        <section className="mt-16">
          ...
          <div className="mt-6">
            <MatchPairs pairs={matchPairs} title="Paper 1 question terms" />
          </div>
        </section>

        <section className="mt-16">
          <h2 className="text-2xl font-black">Quick quiz</h2>
          <p className="mt-1 text-[#526173]">Apply reading strategies to realistic Paper 1 scenarios.</p>
          <div className="mt-6">
