...
const questions = [
  {
    question: "A Paper 2 question says: 'Vrai, Faux ou On ne sait pas? — La conférencière est professeure.' The text says she works in education but doesn't specify her role. What do you answer?",
  ...
  },
  {
    ...
    options: ["Translate every unknown word", "Read the questions first", "Write a summary of what you expect", "Read the text twice through before looking at questions"],
    correct: 1,
  ...
  {
    question: "You hear a recording twice. What should you focus on during the first listen?",
    options: ["Write specific answers to every question", "Identify the main idea, speaker, and purpose", "Only focus on numbers and statistics", "Ignore it and focus entirely on the second listen"],
    correct: 1,
    ...
    <main className="min-h-screen bg-[#FFFDF7] text-[#0B1F3A]">
      <section className="mx-auto max-w-6xl px-6 py-16">
        ...
        <div className="mt-12 rounded-[2rem] border border-[#E7DAB9] bg-white p-8 shadow-sm">
          ...
          <p className="mt-2 text-[#526173]">Unit 3 covers Paper 1 — written production, text types, register, and writing techniques.</p>
